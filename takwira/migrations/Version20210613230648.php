 ...
 */
final class Version20210613230648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX matches_id ON matche');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX matches_id ON matche (matches_id)');
